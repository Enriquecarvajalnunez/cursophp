...
$var1 = 1;
$name = 'Enrique Nuñez Carvajal';
$correo = 'Enrique.carvajal.nunez@gmail.com';

$limitMonths = 12; //ver jobs de arreglo realizados en los ultimos 12 meses
?>
        ...
        <div>
          ...
          <ul>
            ...
            for ($idx = 0; $idx < count($jobs); $idx = $idx + 1) {
              ...
              //sustituye el codigo por la función
              printElements($jobs[$idx]);
            }
            ?>
          </ul>
        </div>
        <div>
          ...
          <div class="project">
            ...
            for ($idx = 0; $idx < count($projects); $idx = $idx + 1) {
              ...
              //sustituye el codigo por la función
              printElementsProject($projects[$idx]);
            }
            ?>
